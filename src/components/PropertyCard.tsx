...
//     onPress && onPress(); // keep existing behavior
//     router.push(`/protected/property/${data._id}`); // keep existing route
//   };
...
//             {/* 3-dot menu (overlay inside header; does not change layout) */}
//             <Menu
//               visible={menuOpen}
...
//                 onPress={(e) => {
//                   setMenuOpen(false);
//                   // Keep body press navigation intact; this is a direct route to Add/Edit screen
//                   router.push("/protected/AddandEditProperty");
//                 }}
//               />
//               <Menu.Item
//                 title="Delete"
